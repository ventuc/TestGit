...
<div class="box">
	...
	<table width="97%" border="0" align="center" cellspacing="0" cellpadding="0">
   		...
   		<td width="28%" align="left" valign="top">
			<div align="center"><b>'.$this->array_lingua['tuo_nome'].'</b><br /><input type="text" name="autore" value="'.@$_SESSION['a'].'" /><br />&nbsp;<br />
    	...
    	<td width="71%" valign="top" align="left">
				...
				<textarea name="mess" style="width: 99%;" rows="9" cols="" onkeyup="conta(this.form)">'.@$_SESSION['b'].''.$this->stringa_quote.'</textarea>
